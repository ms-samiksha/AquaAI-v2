...
class SpeciesResult(BaseModel):
    ...
    # ── NEW coral intelligence fields ──
    bleaching_stage:            Optional[int]       = None   # 0-4
    bleaching_percentage:       Optional[int]       = None   # 0-100
    recovery_probability:       Optional[int]       = None   # 0-100
    weeks_to_irreversible:      Optional[int]       = None   # weeks
    temperature_stress:         Optional[str]       = None   # low/moderate/high/critical
    monitoring_org:             Optional[str]       = None
    monitoring_contact:         Optional[str]       = None
    monitoring_url:             Optional[str]       = None
    immediate_actions:          Optional[List[str]] = []
    ocean_health_score:         Optional[int]       = None   # 0-100
    iucn_status:                Optional[str]       = None
    population_trend:           Optional[str]       = None   # increasing/stable/decreasing/unknown
